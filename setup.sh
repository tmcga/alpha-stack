...
echo "    /deal        Deal execution (M&A, LevFin, restructuring)"
echo "    /markets     Capital markets (ECM, DCM, equity research)"
echo "    /derivatives Options & derivatives pricing"
echo "    /trade       Trading & execution"
echo "    /hedge       Hedge fund strategies"
echo "    /pe          Private capital (buyouts, growth, credit)"
echo "    /real-assets Real estate & infrastructure"
echo "    /portfolio   Portfolio construction & optimization"
echo "    /risk        Risk analytics & stress testing"
echo "    /vc          Venture capital"
echo "    /wealth      Wealth advisory & planning"
echo "    /quant       Quant signals & strategy development"
echo ""
echo "  Alpha Stack is ready. Open Claude Code and try /deal"
echo ""
